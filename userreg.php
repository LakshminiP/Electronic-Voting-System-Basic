...
<h3 class="panel-title" align="center"><font color="blue"><b>Register for Electronic Voting System</b></font></h3>
</div>
<div class="panel-body">
<?php
require 'connect.inc.php';

if(isset($_POST['username']) && isset($_POST['lname'])&& isset($_POST['email']) && isset($_POST['mobile'])
	&& isset($_POST['gender'])&& isset($_POST['password'])&& isset($_POST['cpsw']))
{
	...
	if(!empty($username) && !empty($lname)&& !empty($email)&& !empty($mobile)&& !empty($gender)&& !empty($password)&& !empty($cpsw))
	{
		...
		$query="INSERT INTO viewreg VALUES('".mysql_real_escape_string($username)."',
		'".mysql_real_escape_string($lname)."','".mysql_real_escape_string($email)."',
		'".mysql_real_escape_string($mobile)."','".mysql_real_escape_string($gender)."','".mysql_real_escape_string($password)."','".mysql_real_escape_string($cpsw)."');";
...
<div class="col-xs-6 col-sm-6 col-md-6">
<div class="form-group">
<input type="text" placeholder="Mobile Number" name="mobile" value="<?php if(isset($mobile)){ echo $mobile; } ?>" class="form-control input-sm">
</div>
</div>
<div class="col-xs-6 col-sm-6 col-md-6">
<div class="form-group">
<input type="text" placeholder="Gender (M/F)" name="gender" value="<?php if(isset($gender)){ echo $gender; } ?>" class="form-control input-sm">
</div>
</div>
<div class="col-xs-6 col-sm-6 col-md-6">
<div class="form-group">
